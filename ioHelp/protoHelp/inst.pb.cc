...
namespace protobuf_inst_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_inst_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Inst_MemAccess;
}  // namespace protobuf_inst_2eproto
...
::google::protobuf::internal::SCCInfo<1> scc_info_Inst =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsInst}, {
      &protobuf_inst_2eproto::scc_info_Inst_MemAccess.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "inst.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::EnumDescriptor* Inst_InstType_descriptor() {
  protobuf_inst_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_inst_2eproto::file_level_enum_descriptors[0];
}
...
InstHeader::InstHeader()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_inst_2eproto::scc_info_InstHeader.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* InstHeader::descriptor() {
  ::protobuf_inst_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_inst_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const InstHeader& InstHeader::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_inst_2eproto::scc_info_InstHeader.base);
...
::google::protobuf::Metadata InstHeader::GetMetadata() const {
  protobuf_inst_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_inst_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const Inst_MemAccess& Inst_MemAccess::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_inst_2eproto::scc_info_Inst_MemAccess.base);
  return *internal_default_instance();
}
...
Inst::Inst()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_inst_2eproto::scc_info_Inst.base);
  SharedCtor();
...
const Inst& Inst::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_inst_2eproto::scc_info_Inst.base);
  return *internal_default_instance();
}
