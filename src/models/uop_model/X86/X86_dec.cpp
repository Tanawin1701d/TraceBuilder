...
X86_DECODER::X86_DECODER(): DECODER_BASE(){
     ...
     decodeStorage.insert({"V128_MOV$R$R", (MOP_BASE*)(new MOV_SIM$R$R())});
     decodeStorage.insert({"V128_MOV$R$M", (MOP_BASE*)(new MOV_SIM$R$M())});
     decodeStorage.insert({"V128_MOV$I$R", (MOP_BASE*)(new MOV_SIM$I$R())});
     decodeStorage.insert({"V128_MOV$I$M", (MOP_BASE*)(new MOV_SIM$I$M())});
     decodeStorage.insert({"V128_MOV$M$R", (MOP_BASE*)(new MOV_SIM$M$R())});
     decodeStorage.insert({"V128_MOV$M$M", (MOP_BASE*)(new MOV_SIM$M$M())});
