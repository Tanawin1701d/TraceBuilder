...
#                 loadUoph.addMetaArgs([["0", "4"]],[])
#                 loadUopl.addIo([srcOpr], [tempOpr])
#                 loadUopl.addMetaArgs([["0", "4"]], [])
...
#                 storeUoph.addMetaArgs([], [["0", "4"]])
#                 storeUopl.addIo([tempOpr], [desOpr])
#                 storeUopl.addMetaArgs([], [["0", "4"]])
#                 #### crucial
