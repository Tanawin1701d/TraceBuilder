...
class MOP_CMP_ALL(mop_cen_x86.MOP_BASE_X86):
    def __init__(self, srcOpr0Type, srcOpr1Type, _cxxType_prefix:str, _decKeys: list):
        super().__init__()
        ###### src operand
        ...
        cmpUop = uop_ctrl_flw_x86.UOP_CMP("uop_cmp", _cxxType_prefix)
...
class MOP_JMP_ALL(mop_cen_x86.MOP_BASE_X86):
    def __init__(self, srcOpr0Type, srcOpr1Type, _cxxType_prefix:str, _decKeys: list):
        ...
        ###### create uop for compare
        jmpUop = uop_ctrl_flw_x86.UOP_JMP("uop_jmp", _cxxType_prefix)
